...
%\linkedin{miquel-puerto-martínez-b8a38b166}
%\skype{skypeid}
...
\makecvfooter{\today}{Miquel Puerto Martínez}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
